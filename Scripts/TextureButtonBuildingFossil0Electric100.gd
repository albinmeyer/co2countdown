...
func _ready():
	PATH_STATE_ACTIVE= "res://Resources/building_oil_00_nobg.png"
	PATH_STATE_NEXT_POSSIBLE= "res://Resources/building_oil_00_bgwhite.png"
	PATH_STATE_DISABLED= "res://Resources/building_oil_00_bggray.png"
	DESCRIPTION = "Full CO2 Elimination in the buildings domain.\n"
	PRICE_TO_BUY= 10000
