...
func _ready():
	PATH_STATE_ACTIVE= "res://Resources/agri_meat_00_nobg.png"
	PATH_STATE_NEXT_POSSIBLE= "res://Resources/agri_meat_00_bgwhite.png"
	PATH_STATE_DISABLED= "res://Resources/agri_meat_00_bggray.png"
	DESCRIPTION = "Full CO2 Elimination in the agriculture domain.\n"
	PRICE_TO_BUY= 10000
