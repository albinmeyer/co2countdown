...
func _ready():
	PATH_STATE_ACTIVE= "res://Resources/factory_fossil_00_nobg.png"
	PATH_STATE_NEXT_POSSIBLE= "res://Resources/factory_fossil_00_bgwhite.png"
	PATH_STATE_DISABLED= "res://Resources/factory_fossil_00_bggray.png"
	DESCRIPTION = "Full CO2 Elimination in the industry domain.\n"
	PRICE_TO_BUY= 10000
